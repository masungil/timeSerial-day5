...
언어 모델을 만들 때, 학습 데이터에 한 번도 등장하지 않은 단어가 나오면 확률이 이 되어버리는 문제가 발생합니다. 이를 방지하기 위해 **모든 단어에 아주 작은 확률을 더해주는 과정**을 평활화라고 합니다.
...
삼성전자 주식 2025-10-01 ~ 2026-00-26 종가 기준으로 cvs 파일 사용하여 5일 이동 평균, 20일 이동평균 출력하는 코드 입니다.

1차는 삼성전자 주식 2025-10-01 ~ 2026-00-26 종가 기준으로 차트를 출력하는 예제 파일입니다.
...
2차는 삼성전자 주식 2025-10-01 ~ 2026-00-26 종가 기준으로 5, 20일 이동 평균을 출력하는 코드 입니다.
